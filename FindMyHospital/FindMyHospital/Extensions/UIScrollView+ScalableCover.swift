...
open class ScalableCover: UIImageView {
    ...
    open override func layoutSubviews() {
        ...
        if scrollView.contentOffset.y < 0 {
            ...
            self.frame = CGRect(x: -offset, y: -offset + 65 , width: scrollView.bounds.size.width + offset * 2, height: maxHeight + offset)
        } else {
...
extension UIScrollView {
    ...
    public func addScalableCover(with image: UIImage, maxHeight: CGFloat = 130) {
